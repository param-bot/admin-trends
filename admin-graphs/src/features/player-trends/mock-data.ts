...
export const MOCK_GAME_OPTIONS = [
  ...
  { id: "fish-game", label: "Fish Game" },
  { id: "mines", label: "Mines" },
  { id: "plinko", label: "Plinko" },
  { id: "limbo", label: "Limbo" },
  { id: "hi-lo", label: "Hi-Lo" },
  { id: "sic-bo", label: "Sic Bo" },
  { id: "dragon-tiger", label: "Dragon Tiger" },
  { id: "andar-bahar", label: "Andar Bahar" },
  { id: "teen-patti", label: "Teen Patti" },
  { id: "andar-bahar-live", label: "Andar Bahar Live" },
  { id: "teen-patti-live", label: "Teen Patti Live" },
  { id: "casino-holdem", label: "Casino Hold'em" },
  { id: "texas-holdem", label: "Texas Hold'em" },
  { id: "omaha-poker", label: "Omaha Poker" },
  { id: "stud-poker", label: "Stud Poker" },
  { id: "wheel-game", label: "Wheel Game" },
  { id: "money-wheel", label: "Money Wheel" },
  { id: "game-show", label: "Game Show" },
  { id: "megaways", label: "Megaways" },
  { id: "jackpot-slot", label: "Jackpot Slot" },
  { id: "classic-slot", label: "Classic Slot" },
  { id: "video-slot", label: "Video Slot" },
  { id: "progressive-jackpot", label: "Progressive Jackpot" },
  { id: "multiplayer", label: "Multiplayer" },
  { id: "skill-game", label: "Skill Game" },
  { id: "number-game", label: "Number Game" },
  { id: "card-game", label: "Card Game" },
  { id: "dice-game", label: "Dice Game" },
